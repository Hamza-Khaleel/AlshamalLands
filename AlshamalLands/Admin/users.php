...
if ($conn->connect_error) {
  ...
  $sql = "SELECT id,email, created_user FROM user";
          ...
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
              ...
              <div class="panel-body">
                ...
                <br>
                  <table class="table table-striped table-hover"><tr><th>ID</th><th>Email</th><th>Joined</th></tr>
                <?php
if ($result->num_rows > 0) {


               while($row = $result->fetch_assoc()) {
                echo "<tr><td>" . $row["id"]. "</td><td>" . $row["email"]. "</td><td> " . $row["created_user"]. "</td></tr>";
                }
                echo "</table>";
                } else {
                echo "0 results";
