    ...
    <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="active"><a href="posts.php">Products</a></li>
...
<header id="header">
    <div class="container">
        <div class="row">
            <div class="col-md-10">
                <h1><span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Posts<small>Manage Blog
                        Posts</small></h1>
            </div>
            <div class="col-md-2">
                    ...
                    <div class="panel-body">
                        ...
                        <form method="post" name="myform">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="des" required class="form-control"></textarea>
                            </div>
                        ...
                        <table class="table table-hover" >
                            ...
                            while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                                ...
                                echo "<input type='submit' value='Edit' formaction='edit.php' class='btn btn-warnning'>";
                                echo "</form></td>";
                                echo "</tr>";
                            }
                            ?>
